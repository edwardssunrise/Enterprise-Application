...
{
    /// <summary>
    /// The Data Transfer Object (DTO) layer is used to prevent all table columns in the database tables from being sent to the client, such as:
    ///
